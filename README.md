...
1. Create DNS entries on your Kubernetes endpoint (**This should be created on your local machine**).
2. Create configuration using talosctl (**This should be created on your local machine**).
